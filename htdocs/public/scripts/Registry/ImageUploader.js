...
export default class ImageUploader {
    ...
    static ImageUploader(target = null) {
                    ...
                    if (target) {
                        ...
                        stream.addEventListener("load", (function (o) {
                            ...
                            if (target) {
                                ...
                                let formatFile = this.Utilities.getFormatFileFromDataURl(target.result)
                                    ...
                                    if (context && CanvasRenderingContext2D.prototype.isPrototypeOf(context)) {
                                        ...
                                        img.addEventListener("load", (function (t) {
                                            ...
                                            if (target) {
                                                ...
                                                this.file = this.Utilities.convertDataURLToBlob(this.dataURL)
